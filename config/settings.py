...
EMAIL_FROM_ADDRESS = config("EMAIL_FROM_ADDRESS", default="noreply@bmtc.ac.ke")
EMAIL_USE_TSL = False
ADMIN_EMAIL = config("ADMIN_EMAIL", default="mwendaevansone@gmail.com")
...
STUDENT_ID_PREFIX = config("STUDENT_ID_PREFIX", "BMTC")
LECTURER_ID_PREFIX = config("LECTURER_ID_PREFIX", "LCT")
